...
def multisig_transaction():
    ...
    dummy_transaction = facade.transaction_factory.create_embedded(
        {
            ...
            "message": encode_message("TEST MIJIN dummy"),
        }
    )
    multisig_transaction = facade.transaction_factory.create_embedded(
        {
            "signer_public_key": account_3.public_key,
            "type": "multisig_account_modification_transaction_v1",
            "min_approval_delta": 1,
            "min_removal_delta": 1,
            "address_additions": [address_1, address_2],
            "address_deletions": [],
        }
    )
    ...
    bonded_signature = facade.sign_transaction(account_w, bonded_transaction)
    ...
    # 作成したトランザクションに署名する
    signature = facade.sign_transaction(account_w, hashlock_transaction)
    ...
    def on_message(ws, message):
        ...
        if json_data.get("topic"):
            ...
            if topic == subscribe_topic:
                ...
                print(
                    "Next Command: python ./07_02_aggregate_bonded_transaction_cosign.py address1",
